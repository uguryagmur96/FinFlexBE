...
import static com.finflex.exception.ErrorType.BAD_REQUEST_ERROR;
import static com.finflex.exception.ErrorType.INVALID_USER;
@ControllerAdvice
@Slf4j
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> StartExceptionHandler(AccountException ex){
